...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"shpping.js":[function(require,module,exports) {
...
function handleSubmit(e) {
  ...
  items.push(item);
  log("There are now ".concat(items.length, " in your state"));
  // clear the form
  e.target.reset();
  displayItems();
...
function restoreFromLocalStorage() {
  ...
  if (lsItems.length) {
    lsItems, _readOnlyError("items");
    list.dispatchEvent(new CustomEvent('itemsUpdated'));
  }
}
var buttons = list.querySelector('button', log(buttons));
...
},{}]},{},["../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","shpping.js"], null)
//# sourceMappingURL=/shpping.731fb30b.js.map