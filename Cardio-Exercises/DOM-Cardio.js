...
// have that function return htm that looks like htis:
// <div class="playerCard">
// <h2>NAME - AGE</h2>
// <p>They are HEIGHT and AGE years old. In Dog years this person would be AGEINDOGYYEARS. That would be a tall dog!</p>
// </div>
...
function deleteCard(event) {
    const buttonTatGotClicked = event.currentTarget;
    buttonTatGotClicked.closest(".playerCard").remove();
